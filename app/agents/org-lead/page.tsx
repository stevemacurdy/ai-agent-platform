...
export default function OrganizationLeadPage() {
  const { currentCompany, isLoading } = useTenant();
  const kpis = getAgentKPIs(currentCompany?.name, 'org-lead');
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Organization Lead</h1>
      ...
      <div className="bg-[#0A0E15] border border-white/5 rounded-xl p-6 text-center">
        <p className="text-sm text-gray-400">Full Organization Lead dashboard coming soon.</p>
