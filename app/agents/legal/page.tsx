...
export default function LegalEmployeePage() {
  const { currentCompany, isLoading } = useTenant();
  const kpis = getAgentKPIs(currentCompany?.name, 'legal');
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Legal Employee</h1>
      ...
      <div className="bg-white border border-[#E5E7EB] rounded-xl p-6 text-center">
        <p className="text-sm text-[#6B7280]">Full Legal Employee dashboard coming soon.</p>
