...
export default function SupplyChainAgentPage() {
  ...
  const kpis = getAgentKPIs(currentCompany?.name, 'supply-chain');
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold">Supply Chain Agent</h1>
      ...
      <div className="bg-[#0A0E15] border border-white/5 rounded-xl p-6 text-center">
        <p className="text-sm text-gray-400">Full Supply Chain Agent dashboard coming soon.</p>
