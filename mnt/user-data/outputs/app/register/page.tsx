...
/* ═══════════════════════════════════════════════════════════════
   WoulfAI Register — Branded Design System
      ...
      >
        ...
        <div className="relative z-10 max-w-md">
          <h1 className="text-[40px] font-black text-white leading-[1.1] tracking-tight">
            Build Your
            <br />
            <span style={{ color: '#F5920B' }}>AI Workforce</span>
          </h1>
          <p className="mt-5 text-white/45 leading-relaxed text-[15px]">
            Create your workspace and start hiring AI Employees in minutes. No consultants, no complex
            setup — just choose the roles you need and let them get to work.
          </p>
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <p className="text-[11px] text-white/20">
            Enterprise security · SOC 2 ready · Tenant isolated
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 sm:px-12 py-12">
        <div className="w-full max-w-[420px] animate-fade-up">
          ...
          <p className="mt-1.5 text-[15px] text-gray-500">
            Create your workspace — it takes under 60 seconds
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-7 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                style={{
                  ...inputStyle,
                  borderColor: form.confirm && form.confirm !== form.password ? '#DC4F4F' : '#E5E7EB',
                }}
                {...focusHandlers}
              />
              {form.confirm && form.confirm !== form.password && (
                <p className="mt-1 text-[12px]" style={{ color: '#DC4F4F' }}>
          ...
          <div className="mt-6 text-center">
            <p className="text-[14px] text-gray-500">
              ...
              <Link href="/login" className="font-bold hover:underline" style={{ color: '#1B2A4A' }}>
                Sign in
              </Link>
            </p>
          </div>
