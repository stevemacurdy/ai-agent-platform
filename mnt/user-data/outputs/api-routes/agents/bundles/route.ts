...
// GET /api/agents/bundles — list bundles (optionally with agents)
// GET /api/agents/bundles?slug=finance-suite — single bundle
// GET /api/agents/bundles?companyId=xxx — include company access status
