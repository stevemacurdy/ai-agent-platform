// phase-b-company-switcher.js — Run from project root
// Applies B10: Admin sidebar company switching
var fs = require('fs');

// ============================================================================
// Create CompanySwitcher component
// ============================================================================
var switcher = `'use client'
...
fs.writeFileSync('components/CompanySwitcher.tsx', switcher);
console.log('OK: components/CompanySwitcher.tsx');

// ============================================================================
// Add CompanySwitcher to AdminSidebar
// ============================================================================
var sidebar = fs.readFileSync('components/AdminSidebar.tsx', 'utf8');

// Add import
if (!sidebar.includes('CompanySwitcher')) {
  sidebar = sidebar.replace(
    "import { usePathname } from 'next/navigation'",
    "import { usePathname } from 'next/navigation'\nimport CompanySwitcher from './CompanySwitcher'"
  );

  // Add after logo section, before nav
  sidebar = sidebar.replace(
    '{/* Navigation */}\n      <nav',
    '{/* Company Switcher */}\n      <CompanySwitcher open={open} />\n\n      {/* Navigation */}\n      <nav'
  );

  fs.writeFileSync('components/AdminSidebar.tsx', sidebar);
  console.log('OK: components/AdminSidebar.tsx — added CompanySwitcher');
} else {
  console.log('SKIP: AdminSidebar already has CompanySwitcher');
}
