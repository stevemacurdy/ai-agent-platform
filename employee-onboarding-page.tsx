        ...
        <div className="bg-[#0D1117] border border-white/10 rounded-xl p-8">
          ...
          {step === 0 && (
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold text-white mb-2">Welcome to WoulfAI</h1>
              <p className="text-gray-400 mb-2">You&apos;re joining the team! Let&apos;s get you set up.</p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6 text-left">
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-0.5">{'\u2022'}</span>
                    <span>Access your AI agents (WMS, Operations, HR, Support, Training)</span>
                  </li>
                </ul>
              </div>
              ...
              <button
                onClick={() => setStep(1)}
                className="w-full py-3 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-500 transition-all"
              >
                Get Started
              </button>
            </div>
          ...
          {step === 1 && (
            <div>
              ...
              <div className="flex gap-3 mt-6">
                <button
                  onClick={() => setStep(0)}
                  className="px-4 py-2 rounded-lg border border-white/10 text-gray-400 text-sm hover:bg-white/5 transition-all"
                >
                  Back
                </button>
                <button
                  ...
                  disabled={submitting}
                  className="flex-1 py-3 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-500 disabled:opacity-50 transition-all"
                >
          ...
          {step === 2 && (
            <div className="text-center">
              ...
              <p className="text-gray-400 mb-6">
                Your account is ready. You now have access to {result?.agentCount || 5} AI agents.
              </p>
              ...
              <div className="bg-white/5 border border-white/10 rounded-lg p-4 mb-6">
                ...
                <div className="grid grid-cols-2 gap-2">
                  {[
                    ...
                    <div key={a.name} className="px-3 py-2 bg-white/5 rounded-lg text-left">
